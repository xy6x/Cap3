...
private final ReviewRepository reviewRepository;
    ...
    public void addCar(CarDTO carDTO) {
        ...
        Car car = new Car(null, carDTO.getType(), carDTO.getBrand(), carDTO.getColor(), carDTO.getModel(), carDTO.getLocation(),
                ...
                carDTO.getCurrentStatus(), carDTO.getConditions(), carDTO.getIsChecked(), carDTO.getCount(),0, supplier,null, null, null);
    ...
    public String currentStatus(Integer id) {
        ...
        return "Current Status: " + car.getCurrentStatus();
    }




    public List<Car> getAllCarsNotChecked() {
        List<Car> cars = carRepository.getAllCarsNotChecked();
        if (cars.isEmpty()) {
    ...
    public List<Car> AllCarsSpecificPrice(Integer min , Integer max ,String duration){
