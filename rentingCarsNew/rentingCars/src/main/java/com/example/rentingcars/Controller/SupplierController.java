...
//    }
    ...
    @GetMapping("/getAllCarSameSupplier/{id}")
    public ResponseEntity getAllCarSameSupplier(@PathVariable Integer id){
        //List<> cars =carService.getAllCarSameSupplier(id);
        return ResponseEntity.status(HttpStatus.OK).body(supplierService.getAllCarSameSupplier(id));
